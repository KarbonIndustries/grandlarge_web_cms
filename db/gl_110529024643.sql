...
#
# Host: karbon.dnsalias.com (MySQL 5.1.37)
# Database: grandlargeinc_com_teset_site_aplus_net
# Generation Time: 2011-05-29 02:44:00 -0400
# ************************************************************
...
--
-- Dumping routines (PROCEDURE) for database 'grandlargeinc_com_teset_site_aplus_net'
--
DELIMITER ;;
/*!50003 DROP PROCEDURE IF EXISTS `removeOffice` */;;
/*!50003 SET SESSION SQL_MODE=""*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`%`*/ /*!50003 PROCEDURE `removeOffice`(IN id INT)
BEGIN
